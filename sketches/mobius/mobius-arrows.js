...
void main() {
    ...
    if(t < 50.0) {
        ...
        if (uMode == 0) { // Elliptic (Rotation)
            ...
            gridUV *= 0.75;
            angle = 0.0; // Horizontal flow, not diagonal
        }
        else if (uMode == 3) { // Parabolic (Translation)
            gridUV = (z + vec2(iTime * speed * 2.2, 0.0)) * 1.0;
            angle = 3.0 * PI * 0.5; // Horizontal flow pointing opposite direction
        }
